...
import 'package:splitmate_flutter/controllers/login_controller.dart';
import 'package:splitmate_flutter/services/user_service.dart';
import 'package:splitmate_flutter/views/activity_page.dart';
import 'package:splitmate_flutter/views/dashboard_page.dart';
import 'package:splitmate_flutter/views/profile_page.dart';
import 'package:splitmate_flutter/views/request_page.dart';
import 'package:splitmate_flutter/views/service_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: Sidebar(
        ...
        email: userInfo["email"] ?? "Unknown", // Fetching email from GetStorage
      ),
