...
import 'dart:io';
import 'package:splitmate_flutter/controllers/update_profile_controller.dart';
...
class UpdateProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // Remove background color and add back button
        elevation: 0,
                        ...
                        return updateProfileController.imageFile.value == null
                            ...
                            : ClipRRect(
                                ...
                                child: Image.file(
                                  ...
                                  fit: BoxFit
                                      .contain, // Ensure photo fits height
