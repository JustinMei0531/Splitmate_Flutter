...
import "apply_controller.dart"; // Import the controller
              ...
              children: <Widget>[
                ...
                FadeInDown(
                  child: Padding(
                    ...
                    child: Text(
                      "Enter your email address and property ID to apply to become a new tenant",
                ...
                FadeInDown(
                  child: TextField(
                    // controller: controller.propertyIdController, // Bind the property ID controller
                    decoration: InputDecoration(
                      focusedBorder: OutlineInputBorder(
                        borderSide:
                            const BorderSide(color: Colors.black, width: 1.5),
